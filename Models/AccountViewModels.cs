...
namespace WebApplication1.Models
{
    ...
    {
        [Required(ErrorMessage = "الرجاء ادخال بريد إليكتروني صحيح")]
        [Display(Name = "Email")]
        [EmailAddress]
        public string Email { get; set; }

        [Required(ErrorMessage = "كلمة المرور غير صحيحة")]
    ...
    {
        [Required(ErrorMessage = "الرجاء ادخال البريد الإليكتروني")]
        [EmailAddress]
